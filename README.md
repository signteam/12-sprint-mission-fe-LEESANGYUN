...
3. **next (part3,4): 스프린트 미션 7~ FE 요구사항~**
   ...
   - 만약 스프린트 미션 7부터 프론트엔드 코드를 React가 아닌 Next로 구현하고 싶다면 next 브랜치를 사용해요.

> _스프린트 미션 내 백엔드 요구사항은 [백엔드 레포지토리](https://github.com/codeit-sprint-fullstack/12-sprint-mission-be)의 브랜치에서 관리해주세요_
